...
public class SearchClientes extends javax.swing.JDialog {

    public SearchClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        populaTabela("");
    }
    ...
    private void jBalterarRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBalterarRegistroActionPerformed
        ...
        ac.recebeValores(cod, nome, cpf, endereco);
        ac.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SearchClientes(null, false).setVisible(true);
        });
    }
