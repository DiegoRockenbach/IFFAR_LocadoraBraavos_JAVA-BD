...
public class SearchProdutos extends javax.swing.JDialog {

    public SearchProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        populaTabela("");
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SearchProdutos(null, false).setVisible(true);
        });
    }
