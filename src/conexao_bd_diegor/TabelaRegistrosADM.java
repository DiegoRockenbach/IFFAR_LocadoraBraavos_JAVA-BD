...
public class TabelaRegistrosADM extends javax.swing.JDialog {


    public TabelaRegistrosADM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        populaTabela("");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("REGISTROS DE LOCAÇÃO ADM");
        ...
        jBcriarUSER.setText("Criar conta de usuário");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(jTcodUSER, javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jTproduto, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)))))))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jBsearchProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBsearchProdutoActionPerformed
        SearchProdutosADM spa = new SearchProdutosADM(null, false);
        spa.setVisible(true);
        dispose();
    ...
    private void jBalterarRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBalterarRegistroActionPerformed
        ...
        AlterarRegistroADM ata = new AlterarRegistroADM();
        ata.recebeValores(cod, codUSER, produto, cliente, dataRetiro, dataDevolucao);
        ata.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TabelaRegistrosADM dialog = new TabelaRegistrosADM(new javax.swing.JFrame(), true);
