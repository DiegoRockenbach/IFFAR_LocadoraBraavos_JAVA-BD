...
public class AlterarClienteADM extends javax.swing.JFrame {


    public AlterarClienteADM() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ALTERAR CONTA DE CLIENTE");

        jLabel3.setText("CPF do cliente:");

        jLabel4.setText("Endereço do cliente (cidade):");
        ...
        jLabel8.setText("COD do cliente:");
    ...
    private void jBsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBsalvarActionPerformed
        ...
        try{
            String query = "UPDATE `diegor_2022`.`cliente` SET nome = '"+nome+"', cpf = '"+cpf+"', endereço = '"+endereco+"' WHERE cod = '"+cod+"';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarClienteADM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarClienteADM().setVisible(true);
            }
        });
    }
